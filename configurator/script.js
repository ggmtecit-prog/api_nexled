...
const CUSTOM_FIELD_OVERRIDE_GROUPS = [
    {
        ...
        fields: [
            { key: "display_reference", labelKey: "configurator.quickActions.reference", fallback: "Reference", maxLength: 64, containerId: "custom-output-reference-override-slot" },
            { key: "display_description", labelKey: "configurator.quickActions.description", fallback: "Description", maxLength: 160, containerId: "custom-output-description-override-slot" },
